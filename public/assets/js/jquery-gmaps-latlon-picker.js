...
$.fn.gMapsLatLonPicker = (function() {
	...
	_self.params = {
		defLat : 0.5289842007773696,
		defLng : 105.61065671034157,
		defZoom : 11,
		...
		strings : {
			markerText : "Geser Maker Untuk Memindahkan Lokasi",
			error_empty_field : "Gagal Menemukan Kordinat Tampat Ini",
			error_no_results : "Gagal Menemukan Kordinat Tempat Ini"
		},
	...
	var getLocationName = function(position) {
		...
		_self.vars.geocoder.geocode({'latLng': latlng}, function(results, status) {
			if (status == google.maps.GeocoderStatus.OK && results[0] && results[1]) {
				...
				$(_self.vars.cssID + ".gllSubdistrict").val(results[0].address_components[3].long_name);
				$(_self.vars.cssID + ".gllCity").val(results[0].address_components[4].long_name);
			} else {
